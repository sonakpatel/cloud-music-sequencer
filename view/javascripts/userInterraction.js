 ...
 * *******************************************************
 *
 * Connection to the server to send/receive event and data
 * First: getting objects to manipulate: 'musics' in our lists
 * from the server for freshly new connected clients
 * Then manipulating the different user's events relative to:
 * Addition from samples to the samples selected list
 * Deletion of selected samples
 * Display of all the different samples
 *
 * *******************************************************
 */
 ...
 * *******************************************************
 *
 * Overwriting different operation in our list
 * in order to make it collaborative and real-time
 *
 * *******************************************************
 */
 ...
 * *******************************************************
 *
 * Finally, managning all the different informative message
 * coming from the server, due (or not) to the user interraction
 *
 * *******************************************************
 */
