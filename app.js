 ...
 * *******************************************************
 *
 * Declaration of the JSON on the server side, in order
 * to share it with remotes clients
 *
 *  *******************************************************
 */
 ...
 * *******************************************************
 *
 * Modification of handler function, in order to return proper
 * ContentType for the different file requested: html/js/css/images
 *
 *  *******************************************************
 */
 ...
 * *******************************************************
 *
 * Function enabling the log of information:
 * -Into a file, in order to be able to retrieve it
 * -Into the console in order to be able to see it while running
 *
 * *******************************************************
 */
function log(s, socket) {
	...
	var logpath = "./cloudMusicProduction.log";
	var fs = require('fs');
...
io.sockets.on('connection', function (socket) {
	 ...
	 *
	 * Note: Future will be replaced by loging in system
	 *
	 * *******************************************************
	 */
